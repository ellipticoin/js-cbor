...
describe("Arrays:", function () {
  ...
  var examples = [
    ...
    {
      data: [1, 2, 3],
      encoded: Buffer.from("83010203", "hex"),
      symmetric: true,
    },
    {
      data: [1, [2, 3], [4, 5]],
      encoded: Buffer.from("8301820203820405", "hex"),
      symmetric: true,
    },
    {
      data: [
    ...
    {
      data: [1, [2, 3], [4, 5]],
      encoded: Buffer.from("9f018202039f0405ffff", "hex"),
      symmetric: false,
    },
    {
      data: [1, [2, 3], [4, 5]],
      encoded: Buffer.from("9f01820203820405ff", "hex"),
      symmetric: false,
    },
    {
      data: [1, [2, 3], [4, 5]],
      encoded: Buffer.from("83018202039f0405ff", "hex"),
      symmetric: false,
    },
    {
      data: [1, [2, 3], [4, 5]],
      encoded: Buffer.from("83019f0203ff820405", "hex"),
      symmetric: false,
    },
  ];
